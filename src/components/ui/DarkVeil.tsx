...
export default function DarkVeil({
  ...
  useEffect(() => {
    ...
    gl.attachShader(prog, compileShader(gl.VERTEX_SHADER, vertex));
    gl.attachShader(prog, compileShader(gl.FRAGMENT_SHADER, fragment));
    gl.linkProgram(prog);
    gl.useProgram(prog);
    ...
    const uScanLoc  = gl.getUniformLocation(prog, 'uScan');
    const uFreqLoc  = gl.getUniformLocation(prog, 'uScanFreq');
    ...
    const loop = () => {
      ...
      gl.uniform1f(uFreqLoc,  scanlineFrequency);
